...
/*
a simple eg to show what it would be like with a simple <form action> login page that would
post to the site, using basic redirection for everything. Not realistic as there won't be
any error notification just redirect to the login page, don't even have a register.html
here, but easy to see you'd use passport-local-mongoose for all that.
 */
